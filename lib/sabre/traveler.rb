module Sabre
  module Traveler
    def self.profile(session,first_name,last_name,phone)
      ...
      response = client.request(:travel_itinerary_add_info_rq, Sabre.request_header('2.0.0')) do
    ...
    def self.locate(session, transaction_code, reservation_id)
      ...
      response = client.request(:travel_itinerary_read_rq, Sabre.request_header('2.0.0')) do
        Sabre.namespaces(soap)
